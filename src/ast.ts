...
export interface ParserOptions {
  ...
  error?: ErrorCallback;
  debug?: boolean;
  vendor?: "mssql" | "postgres" | "mysql" | "sqlite";
...
export interface PlusOperator extends SyntaxNode {
  kind: SyntaxKind.plus_token;
}
export interface MinusOperator extends SyntaxNode {
  kind: SyntaxKind.minus_token;
}
export interface MultiplyOperator extends SyntaxNode {
  kind: SyntaxKind.mul_token;
}
export interface DivideOperator extends SyntaxNode {
  kind: SyntaxKind.div_token;
}
export interface BitwiseOrOperator extends SyntaxNode {
  kind: SyntaxKind.bitwise_or_token;
}
export interface BitwiseAndOperator extends SyntaxNode {
  kind: SyntaxKind.bitwise_and_token;
}

export interface EqualsOperator extends SyntaxNode {
  kind: SyntaxKind.equal;
}
export interface NotEqualsOperator extends SyntaxNode {
  kind: SyntaxKind.notEqual;
}
export interface AnsiNotEqualsOperator extends SyntaxNode {
  kind: SyntaxKind.ltGt;
}
export interface OrOperator extends SyntaxNode {
  kind: SyntaxKind.or_keyword;
}
export interface AndOperator extends SyntaxNode {
  kind: SyntaxKind.and_keyword;
}
export interface GreaterThanOperator extends SyntaxNode {
  kind: SyntaxKind.greaterThan;
}
export interface LessThanOperator extends SyntaxNode {
  kind: SyntaxKind.lessThan;
}
export interface GreaterThanEqualOperator extends SyntaxNode {
  kind: SyntaxKind.greaterThanEqual;
}
export interface LessThanEqualOperator extends SyntaxNode {
  kind: SyntaxKind.lessThanEqual;
}
export interface LikeOperator extends SyntaxNode {
  kind: SyntaxKind.like_keyword;
}
export interface InOperator extends SyntaxNode {
  kind: SyntaxKind.in_keyword;
}
export interface NotGreaterThanOperator extends SyntaxNode {
  kind: SyntaxKind.notGreaterThan;
}
export interface NotLessThanOperator extends SyntaxNode {
...
export interface ExistsOperator extends SyntaxNode {
  kind: SyntaxKind.exists_keyword;
}

export interface NotOperator extends SyntaxNode {
  kind: SyntaxKind.not_keyword;
}

export interface DefaultLiteral extends SyntaxNode {
  kind: SyntaxKind.default_keyword;
}

// some/any act like unary operators
// but they can only be used as the RHS of a comparison
export interface SomeOperator extends SyntaxNode {
  kind: SyntaxKind.some_keyword;
}
export interface AnyOperator extends SyntaxNode {
...
export interface PlusEqualsOperator extends SyntaxNode {
  kind: SyntaxKind.plusEqualsAssignment;
}
export interface MinusEqualsOperator extends SyntaxNode {
  kind: SyntaxKind.minusEqualsAssignment;
}
export interface MultiplyEqualsOperator extends SyntaxNode {
  kind: SyntaxKind.mulEqualsAssignment;
}
export interface DivEqualsOperator extends SyntaxNode {
  kind: SyntaxKind.divEqualsAssignment;
}
export interface ModEqualsOperator extends SyntaxNode {
  kind: SyntaxKind.modEqualsAssignment;
}
export interface AndEqualsOperator extends SyntaxNode {
  kind: SyntaxKind.bitwiseAndAssignment;
}
export interface XorEqualsOperator extends SyntaxNode {
  kind: SyntaxKind.bitwiseXorAssignment;
}
export interface OrEqualsOperator extends SyntaxNode {
...
export interface NullExpression extends SyntaxNode {
  kind: SyntaxKind.null_keyword;
}

export type ConstantExpression =
  //   | DefaultLiteral
  NullExpression | LiteralExpression;
...
// todo: distributed transactions?
export interface BeginTransactionStatement extends SyntaxNode {
  name?: string;
  mark?: string;
}

export interface CommitTransactionStatement extends SyntaxNode {
  name_or_save_point?: string;
  delayedDurability?: boolean; // ON | OFF
}

// rollback of specific tran, or ALL transactions
export interface RollbackTransactionStatement extends SyntaxNode {
  name?: string;
}
...
export interface BlockComment extends SyntaxNode {
  kind: SyntaxKind.comment_block;
}
export interface InlineComment extends SyntaxNode {
  kind: SyntaxKind.comment_inline;
}

export type Comment = BlockComment | InlineComment;

// support is null and is not null?
export function isComparison(op: BinaryOperator) {
  switch (op.kind) {
...
export function isUnary(expr: Expr) {
  const kind = expr.kind;
  return (
    kind === SyntaxKind.unary_minus_expr ||
